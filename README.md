...
- **แตะที่แผนที่** = การ์ดแจ้งเตือน "งานค้าง" เด้งขึ้น (ปุ่มในชีทล่างไม่ทำให้เด้ง)
- แตะโลโก้เหลืองบนการ์ดเส้นทาง = แจ้งเตือน · แตะค้าง = ไปหน้าล็อกพร้อมแจ้งเตือน
- แท็บ "โปรไฟล์" = ไปหน้า Lock Screen · บนหน้าล็อก แตะจอ 3 ครั้ง = แจ้งเตือนขึ้น · แตะ 4 ครั้ง = กลับหน้านำทาง
